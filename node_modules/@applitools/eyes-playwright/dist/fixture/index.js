...
exports.test = test_1.test.extend({
    ...
    page: async ({ page, eyesRunner, eyesConfig }, use) => {
        ...
        // Track main page for multi-page support: all new pages in the same context should reference this main page
        // Runner and config can be accessed via page.__eyesMainPage.__eyesRunner and page.__eyesMainPage.__eyesConfig
        const context = page.context();
        context.on('page', newPage => {
            ;
            newPage.__eyesMainPage = page;
        });
        await use(page);
    },
    eyes: [
