...
exports.expect = test_1.expect.extend({
    async toHaveScreenshot(pageOrLocator, nameOrOptions = {}, optOptions = {}) {
        ...
        // If targetPage has no Eyes instance, fall back to the targetPage itself (backward compatibility)
        const mainPage = targetPage.__eyes ? targetPage : (_b = targetPage.__eyesMainPage) !== null && _b !== void 0 ? _b : targetPage;
        const options = {
            ...optOptions,
        ...
        const configuration = (_c = mainPage.__eyesConfig) !== null && _c !== void 0 ? _c : {};
        configuration.properties = [
            ...((_d = configuration.properties) !== null && _d !== void 0 ? _d : []),
            {
        ...
        await (await (0, getEyes_1.getEyes)({
            testInfo,
            eyesConfig: (_e = mainPage.__eyesConfig) !== null && _e !== void 0 ? _e : {},
            eyesRunner: (_f = mainPage.__eyesRunner) !== null && _f !== void 0 ? _f : {},
            page: mainPage,
        })).check({
            name: typeof nameOrOptions === 'string'
                ...
                : Array.isArray(nameOrOptions)
                    ...
                    : typeof (nameOrOptions === null || nameOrOptions === void 0 ? void 0 : nameOrOptions.name) === 'string'
                        ? nameOrOptions.name
                        : undefined,
            page: targetPage !== mainPage ? targetPage : undefined,
            region: locator !== null && locator !== void 0 ? locator : options.clip,
            fully: (_g = options.fullPage) !== null && _g !== void 0 ? _g : configuration.fully,
