...
function makeProcessResources({ fetchResource, uploadResource, cache = new Map(), asyncCache, logger: mainLogger, }) {
    ...
    async function processUrlResource({ resource, settings, logger = mainLogger, }) {
        logger.log(`Processing url resource ${resource.url} with id ${resource.id} httpVersion=${settings === null || settings === void 0 ? void 0 : settings.httpVersion}`);
        ...
        async function fetchAndUpload() {
            var _a;
            logger.log(`Fetching and uploading resource ${resource.url} with id ${resource.id} httpVersion=${settings === null || settings === void 0 ? void 0 : settings.httpVersion}`);
            try {
