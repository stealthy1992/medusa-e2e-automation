...
function makeTunnelClient({ settings, logger: defaultLogger, } = {}) {
    ...
    // TODO: Remove this deprecation warning after 2026 is over
    if (utils.general.getEnvValue('EC_TUNNEL_USE_FRP', 'boolean')) {
        logger.warn('WARNING: The APPLITOOLS_EC_TUNNEL_USE_FRP environment variable is no longer supported. ' +
            'FRP (Fast Reverse Proxy) tunnels have been deprecated and removed from EC/EG. ' +
            'If you have questions or need assistance, please contact Applitools Support.');
    }
    const getTunnelService = utils.general.cachify(async (region) => {
        ...
        const { port, cleanupFunction, connectivityTest } = await (0, execution_grid_tunnel_1.startEgTunnelService)({
            ...
            logger,
            tunnelLogFileDirectory: (_a = process.env.APPLITOOLS_EG_TUNNEL_LOG_FILES_DIRECTORY) !== null && _a !== void 0 ? _a : utils_1.LOG_DIRNAME,
            pacFile: settings === null || settings === void 0 ? void 0 : settings.pacFile,
            pacScript: settings === null || settings === void 0 ? void 0 : settings.pacScript,
            pacUrl: settings === null || settings === void 0 ? void 0 : settings.pacUrl,
        });
        return {
