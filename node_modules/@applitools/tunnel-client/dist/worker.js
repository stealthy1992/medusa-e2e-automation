...
function makeTunnelClientWorker({ settings, logger: defaultLogger, }) {
    ...
    if (!processHandlersRegistered) {
        ...
        process.on('unhandledRejection', error => {
            ...
            currentLogger.console.error(errorMessage);
            restartTunnelClientWorker({ settings: currentSettings, logger: currentLogger });
        });
...
async function runSession({ settings, logger }) {
    ...
    return new Promise((resolve, reject) => {
        socket.on('TunnelClient.close', async (reason) => {
            ...
            (0, req_logs_1.reportToCoralogix)({
                settings: {
                    level: 0,
                ...
                logger.warn('Failed to report error to coralogix', error);
            });
