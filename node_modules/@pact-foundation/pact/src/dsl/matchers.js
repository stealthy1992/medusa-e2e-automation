...
const matcherError_1 = __importDefault(require("../errors/matcherError"));
...
function eachLike(template, opts) {
    ...
    const min = !(0, lodash_1.isEmpty)(opts) && opts ? opts.min : 1;
    return {
        value: (0, ramda_1.times)(() => template, min),
        getValue: () => (0, ramda_1.times)(() => template, min),
 ...
 * String MatcherV2.
 */
function string(value = 'iloveorange') {
    return somethingLike(value);
}
...
function extractPayload(value) {
    ...
    if (value !== null && typeof value === 'object') {
        return Object.keys(value).reduce((acc, propName) => {
            acc[propName] = extractPayload(value[propName]);
            return acc;
        }, {});
    }
    return value;
