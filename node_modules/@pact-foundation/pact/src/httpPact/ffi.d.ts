...
import type { Headers, Query, RequestOptions, ResponseOptions } from '../dsl/interaction';
...
export declare const setBody: (part: InteractionPart, interaction: ConsumerInteraction, headers?: Headers, body?: unknown) => void;
