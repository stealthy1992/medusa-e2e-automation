...
const asyncMessage = (ffi, interactionPtr, pactPtr, messageCount, index) => ({
    ...
    setPending: (pending) => ffi.pactffiSetPending(interactionPtr, pending),
    setComment: (key, value) => ffi.pactffiSetComment(interactionPtr, key, value),
    addTextComment: (comment) => ffi.pactffiAddTextComment(interactionPtr, comment),
    addInteractionReference: (group, name, value) => ffi.pactffiAddInteractionReference(interactionPtr, group, name, value),
    setInteractionTestName: (name) => ffi.pactffiInteractionTestName(interactionPtr, name),
