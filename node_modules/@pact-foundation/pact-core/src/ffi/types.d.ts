...
export type FfiConsumerFunctions = {
    ...
    pactffiSetComment(handle: FfiInteractionHandle, key: string, value: string): boolean;
    pactffiAddTextComment(handle: FfiInteractionHandle, comment: string): boolean;
    pactffiAddInteractionReference(handle: FfiInteractionHandle, group: string, name: string, value: string): boolean;
    pactffiInteractionTestName(handle: FfiInteractionHandle, name: string): number;
